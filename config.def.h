...
static const char *fonts[]          = { "monospace:size=14", "FreeMono:size=14:style=bold" };
...
static const char col_green[]       = "#007755";
...
static const Layout layouts[] = {
	...
	{ "[stack]",    NULL },    /* no layout function means floating behavior */
	{ "[monocle]",  monocle },
};
